...
function button_enable(countryId){
    ...
    var country_id=getItem('countryId');
    var t_str="#";
    var country_id_t=t_str.concat(country_id);
...
function pageLoaded() {        // Commented above line and added this line.
    ...
    if(getItem('proxyMode') != "off" && getItem('proxyMode') != "on"){
        ...
        document.getElementById("plugins_N").style.color = "black"; 
                ...
                // alert("Proxy not ON or not OFF");
    }

    // if(localStorage.getItem('proxyMode') == "off") {             // ***** Chrome.storage changes *****
    if(getItem('proxyMode') == "off") {
        ...
        chrome.browserAction.setIcon({ 
            path : "images/ic24_off.png" 
        });
                    // alert('proxy off1');
                    //ProxyIcon.setPageAction(tabId, "Click to change proxy settings", "images/ic24_off.png");
    } else {
                    // alert('proxy ON');
        ...
        document.getElementById("plugins_Y").style.backgroundColor = "#59BA59";  
                     ...
                     //chrome.browserAction.setIcon(tabId, "Click to change proxy settings", "images/ic24_on.png");
                     // $("input[type=radio]").attr('disabled', false);
                     //$("#lyonFranceProxy").attr("disabled", false);
        // button_enable(localStorage.getItem('countryId'));       // ***** Chrome.storage changes *****
        button_enable(getItem('countryId'));
                      // alert('proxy ON1');
    ...
    chrome.tabs.getSelected(null, function (tab) {
        ...
        $('#plugins_Y').click(function(){
            ...
            button_enable(countryId);
            connect_to_country(countryId);
        })


        $('#plugins_N').click(function(){
            // $(localStorage.getItem('countryId')).prop("checked", false);
